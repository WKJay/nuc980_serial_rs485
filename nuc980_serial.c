...
#define RS485_SEND_ACTIVE 0
#define NUC980_SERIAL_USE_RS485 1
...
static void rs485_start_rx(struct uart_nuc980_port *port)
{
	...
	{
	case 1:
		gpio_direction_output(NUC980_PA2, !RS485_SEND_ACTIVE);
		break;
	case 2:
		gpio_direction_output(NUC980_PA8, !RS485_SEND_ACTIVE);
		break;
	case 3:
		gpio_direction_output(NUC980_PC2, !RS485_SEND_ACTIVE);
		break;
	case 4:
		gpio_direction_output(NUC980_PD14, !RS485_SEND_ACTIVE);
		break;
	case 6:
		gpio_direction_output(NUC980_PA6, !RS485_SEND_ACTIVE);
		break;
	case 7:
		gpio_direction_output(NUC980_PB0, !RS485_SEND_ACTIVE);
		break;
	case 8:
		gpio_direction_output(NUC980_PA7, !RS485_SEND_ACTIVE);
		break;
	case 9:
		gpio_direction_output(NUC980_PB2, !RS485_SEND_ACTIVE);
		break;
	}
}
...
#if NUC980_SERIAL_USE_RS485
	if ((ier = serial_in(p, UART_REG_IER)) & TXEND_IEN)
	{
		serial_out(p, UART_REG_IER, ier & ~TXEND_IEN);
	}
    rs485_start_rx(p);
#else
...
#if NUC980_SERIAL_USE_RS485
		serial_out(up, UART_REG_IER, ier & ~(TXEND_IEN));
#else
